...
--}}
                            <x-custom-select
                                label="{{ __('user.roles') }}"
                                name="roles"
                                route="{{ route('admin.roles.selectlist','roles')}}"
                                method="selectroles"
                                :options="[]">
                            </x-custom-select>
                            @error('roles')
                        ...
                        <div class="mb-3">
                           {{-- <label  class="form-label">Authorization</label>
                            ...
                            <x-custom-select
                                label="{{ __('user.authorization') }}"
                                name="permissions"
                                route="{{ route('admin.permissions.selectlist','permissions')}}"
                                method="selectpermissions"
                                :options="[]">
                            </x-custom-select>
    ...
    <x-custom-modal id="selectroles" size="modal-xl" name="{{ __('user.roles') }}"></x-custom-modal>
    <x-custom-modal id="selectpermissions" size="modal-xl" name="{{ __('user.permissions') }}"></x-custom-modal>
